...
export const useAppIndexStore: StoreDefinition<'appindex', IAppIndexStore> = defineStore('appindex', {
  state: (): IAppIndexStore => {
    return {
      _steady: {
        local: {
          title: '',
  ...
  getters: {
    steady(state: IAppIndexStore) {
      return state._steady
    }
  },
  actions: {
    setSteady(value: IAppIndexSteady) {
